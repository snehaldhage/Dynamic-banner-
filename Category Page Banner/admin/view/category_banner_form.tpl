  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-banner" class="form-horizontal">
        ...
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="input-categry">Select Category</label>
          <div class="col-sm-10">
              ...
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <td class="text-center">Mobile image</td>
                  ...
                  <?php if (isset($banner_images[$language['language_id']])) { ?>
                    <?php foreach ($banner_images[$language['language_id']] as $banner_image) { ?>
                      <tr id="image-row<?php echo $image_row; ?>">
                        <td class="text-left" style="width: 20%;"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][title]" value="<?php echo $banner_image['title']; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control" />
                          <?php if (isset($error_banner_image[$language['language_id']][$image_row])) { ?>
                            ...
                            <td class="text-center"><a href="" id="thumb-image-<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $banner_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                              ...
                              <td class="text-center"><a href="" id="thumb-imagee-<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $banner_image['mobile_thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                                <input type="hidden" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][mobile_image]" value="<?php echo $banner_image['mobile_image']; ?>" id="input-imagee<?php echo $image_row; ?>" /></td>
                                ...
                                <td class="text-center" style="width: 10%;">
                                  <select name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][status]" id="input-status" class="form-control">
                                ...
                                <td class="text-left"><input type="date" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][start_date]" value="<?php echo $banner_image['start_date']; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control" />
                                  <?php if (isset($error_banner_image[$language['language_id']][$image_row])) { ?>
                                    <div class="text-danger"><?php echo $error_banner_image[$language['language_id']][$image_row]; ?></div>
                                    <?php } ?></td>

                                    <td class="text-left"><input type="date" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][end_date]" value="<?php echo $banner_image['end_date']; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control" />
                                      <?php if (isset($error_banner_image[$language['language_id']][$image_row])) { ?>
                                        <div class="text-danger"><?php echo $error_banner_image[$language['language_id']][$image_row]; ?></div>
                                        <?php } ?></td>
                ...
                function addImage(language_id) {
                 ...
                 html += '  <td class="text-left" style="width: 20%;"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][title]" value="" placeholder="<?php echo $entry_title; ?>" class="form-control" /></td>';	
                 ...
                 html += '  <td class="text-center"><a href="" id="thumb-imagee' + image_row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="banner_image[' + language_id + '][' + image_row + '][mobile_image]" value="" id="input-imagee' + image_row + '" /></td>';
                 ...
                 html += '  <td class="text-left" style="width: 10%;"><select name="banner_image[' + language_id + '][' + image_row + '][status]"  class="form-control" >';
                ...
                <?php } ?>
                 ...
                 html += '  <td class="text-left"><input type="date" name="banner_image[' + language_id + '][' + image_row + '][start_date]" value=""  class="form-control" /></td>';

                 html += '  <td class="text-left"><input type="date" name="banner_image[' + language_id + '][' + image_row + '][end_date]" value=""  class="form-control" /></td>';
